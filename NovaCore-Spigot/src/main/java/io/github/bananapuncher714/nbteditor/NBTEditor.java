...
public final class NBTEditor {
	...
	/**
	 * Gets an NBTCompound from the item provided. Use
	...
	/**
	 * Gets an NBTCompound from the entity provided. Use
	 * {@link #getNBTCompound(Object, Object...)} instead.
	 * 
	...
	/**
	 * Gets an NBT tag in a given block with the specified keys. Use
	 * {@link #getNBTCompound(Object, Object...)} instead.
	 * 
	...
	private static abstract class ReflectionTarget implements Comparable<ReflectionTarget> {
		...
		// Provide an external alternative to fetching classes, kind of like a
		// classloader
